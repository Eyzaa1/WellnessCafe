                    ...
                    <div class="tab-pane active">
                          ...
                          <div class="row">
                            <div class="col-12 col-sm-8 mb-3">
                              <div class="form-group">
                                <label for="category">Kategori Pengluaran</label>
                            ...
                            <div class="col-12 col-sm-4 mb-3">
                              <div class="form-group">
                                <label for="outcome">Total Pengeluaran</label>
                                <input class="form-control" type="text" id="outcome" name="outcome"
                                  placeholder="Total pengeluaran" value="{{ old('outcome') }}">
                                @error('outcome')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                              </div>
                      ...
                      <div class="row">
                        <div class="col d-flex justify-content-end">
                          <a class="btn btn-secondary mx-3" href="/transaction">Back</a>
