            ...
            <div class="accordion" id="accordionMain">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input id="product_name" name="product_name" value="{{ $product->product_name }}"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="hidden" id="price" name="price"
                                        data-truePrice="{{ old('price', $product->price) }}" value="Rp.
                {{ old('price', $product->price) }}" type="text" class="form-control" disabled>
                                    ...
                                    <input type="hidden" id="price" name="price"
                                        ...
                                        value="Rp. {{ old('price', ((100 - $product->discount)/100) *$product->price) }}"
                                        type="text" class="form-control" disabled>
                                    @endif
                                    <div class="input-group" style="display:unset;">
                                        <div class="input-group-prepend">
                                            ...
                                            <span class="input-group-text">Rp.
                                                {{ ((100 - $product->discount)/100) * $product->price }} <span
                        ...
                        <div class="form-group mb-3">
                            ...
                            <input type="hidden" name="shipping_address"  value="{{ old('address', auth()->user()->address) }}">
                ...
                old('payment_method')=='1' ? 'checked' : '' }} onclick="hideMessage('bank')">
                        ...
                        <span>
                            <img src="{{ asset('storage/icons/online-banking.png') }}" height="50px"
                                alt="logo online banking">
                        </span>
                    </h2>
                    <div id="collapseCC"
                        class="accordion-collapse collapse {{ old('payment_method')==1 ? 'show' : '' }}"
                        data-bs-parent="#accordionMain">
                        <div class="accordion-body">
                            <div>Select Bank:</div>
                           
                            <div id="bca" class="form-check w-100 collapsed">
                                <span><img src="{{ asset('storage/icons/bank-bca.svg') }}" alt="bca logo"
                                        width="40px"></span>
                                <input type="radio" id="bank_bca" class="bank" name="bank_id" value="1" {{ old('bank_id')=='1'
                  ? 'checked' : '' }} style="appearance: none;">
                                ...
                                <div id="section_bca" class="accordion-collapse collapse fade collapse-pilih-bank"
                                    ...
                                    <div class="rek-content d-flex justify-content-between mt-1">
                                        <small class="no-rek">123 4567 8909 0987</small>
                                        <small class="salin-rek">Yuka Wardana</small>
                                    </div>
                                    <div class="divider"></div>
                    ...
                    <h2 class="h5 px-4 py-3 accordion-header d-flex justify-content-between align-items-center">
                        <div class="form-check w-100 collapsed">
                            <input class="form-check-input" type="radio" name="payment_method" id="cod"
                                data-bs-toggle="collapse" data-bs-target="#collapsePP" aria-expanded="false" value="2" {{ old('payment_method')=='2' ? 'checked'
                : '' }} onclick="hideMessage('cod')">
                            <label class="form-check-label pt-1" for="cod" data-bs-toggle="collapse"
                                data-bs-target="#collapsePP" aria-expanded="false" onclick="hideMessage('cod')">
                                Cash on Delivery
                            </label>
                            @error('payment_method')
                    ...
                    <div id="collapsePP"
                        class="accordion-collapse collapse  {{ old('payment_method')==2 ? 'show' : '' }}"
                        data-bs-parent="#accordionMain">
                        <div class="accordion-body">
                            <div class="content-cod">
                                <div class="note-cod">Note: gunakan metode ini jika tidak memiliki rekening</div>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="col-12 col-lg-3">
            <div class="card position-sticky top-0">
                <div class="p-3 bg-light bg-opacity-10">
                    <h6 class="card-title mb-3">Pesanan Total</h6>
                    {{-- loading --}}
                    <div id="loading_transaction" style="display: none">
                        <lottie-player src="https://assets8.lottiefiles.com/packages/lf20_raiw2hpe.json"
                            background="transparent" speed="1" style="width: auto; height: 125px;" loop autoplay>
                        </lottie-player>
                    </div>
                    {{-- transaction resume --}}
                    <div id="transaction">
                        ...
                        <div class="d-flex justify-content-between mb-1 small">
                            <span>Coupon
                                ...
                                <span class="align-items-center">
                                    <label for="use_coupon" style="cursor:pointer">(pakai coupon</label>
                                </span>
                                <span>
                    ...
                    <div class="form-group small mb-3">
                        Jika Anda ingin mendapatkan informasi lebih lanjut, silakan hubungi  <a class="link-danger"
                            href="https://wa.me/62895377343574?text=Saya%20ingin%20menanyakan%20detail%20terkait%20produk%20anda"
