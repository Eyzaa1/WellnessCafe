                        ...
                        <div class="card-body">
                            <div class="e-profile">
                                <div class="row">
                                    <div class="col-12 col-sm-auto mb-3">
                                        <img class="img-account-profile mb-2"
                                            src="{{ asset('storage/' . $order->product->image)}}" width="200"
                                    ...
                                    <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                                        <div class="text-sm-left mb-2 mb-sm-0">
                                            ...
                                            <div class="text-muted">
                                                ...
                                                <small style="transition:1s;cursor:pointer;"
                                            ...
                                            <div class="mt-2">
                                                ...
                                                <!-- Form -->
                                                <form action="/order/edit_order/{{ $order->id }}"
                                                    enctype="multipart/form-data" method="post" id="form_edit_order">
                                                    @csrf
                                            </div>
                                        </div>
                                ...
                                <ul class="nav nav-tabs">
                                    <li class="nav-item"><a href="" class="active nav-link">Form of {{ $title }}</a>
                                    </li>
                                </ul>
                                                    ...
                                                    <div class="col-12 col-md-6">
                                                        <div class="form-group">
                                                            ...
                                                            <input class="form-control" type="text" id="product_name"
                                                                name="product_name"
                                                                value="{{ old('product_name', $order->product->product_name) }}"
                                                                disabled>
                                                        </div>
                                                    </div>
                                                    <div class="col-12 col-md-3">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="hidden" id="product_price" name="product_price"
                                                                data-truePrice="{{ old('price', $order->product->price) }}"
                                                                value="Rp.
                                    ...
                                    $order->product->price }} <span class="strikethrough ms-4">
                                                    ...
                                                    <div class="col">
                                                        <div class="form-group">
                                                            ...
                                                            <div class="form-control d-flex justify-content-between align-items-center"
                                                                ...
                                                                {{ $order->payment->payment_method }} <em
                                                                    class="link-danger">Sorry, can't make
                                                        ...
                                                        <div class="form-group mb-3">
                                                            ...
                                                            <div
                                                                ...
                                                                <img src="{{ asset('storage/' . $order->transaction_doc) }}"
                                                                    width="150" id="image_preview_proof_edit">
                                                                <div class="mt-3">
                                                                    <p class="text-secondary mb-1">upload tranfer proof
                                                                    </p>
                                                                    <div
                                                                        ...
                                                                        @if ($order->transaction_doc !=
                                                                        env("IMAGE_PROOF"))
                                                                        <a id="button_delete_proof"
                                                                            href="/order/delete_proof/{{ $order->id }}"
                                        ...
                                        <div class="row">
                                            <div class="col d-flex justify-content-end">
                                                <a class="btn btn-outline-secondary mx-3" href="/order/order_data">Back
                                                    to Order List</a>
                                                <button class="btn btn-dark" type="submit" id="button_edit_order">Save
                                                    Changes</button>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div class="p-3 bg-light bg-opacity-10">
                    ...
                    <div id="transaction">
                        ...
                        <div class="d-flex justify-content-between mb-1 small text-danger">
                            <span>Coupon used</span> <span><span id="kuponUsedShow"
                                    data-kuponUsed={{ $order->coupon_used }}>
