                ...
                <div class="row">
                  ...
                  <div class="col d-flex flex-column flex-sm-row justify-content-between mb-3">
                    <div class="text-sm-left mb-2 mb-sm-0">
                      ...
                      <div class="text-muted"><small>Terakhir update {{ date('d M Y', strtotime($product->updated_at))
                          }}
                        </small></div>
                      <div class="mt-2">
                        <!-- Form -->
                    ...
                    <div class="text-center">
                      ...
                      <div class="text-muted"><small>Dibuat pada: {{ date('d M Y', strtotime($product->created_at)) }}
                        </small></div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="tab-pane active">
                    <div class="row">
                      <div class="col">
                        ...
                        <div class="row">
                          <div class="col mb-3">
                            <div class="form-group">
                              <label for="orientation">Tujuan Produk</label>
                    ...
                    <div class=" row">
                      <div class="col d-flex justify-content-end">
                        <a class="btn btn-primary mx-3" href="/product">Back</a>
                        <button class="btn btn-primary" type="submit" id="button_edit_product">Update Produk</button>
                      </div>
                    </div>
                    </form>
                  </div>
