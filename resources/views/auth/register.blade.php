                ...
                <div class="col-lg">
                    <div class="p-5">
                        <div class="text-center">
                            <h1 class="h4 text-gray-900 mb-4">{{ $title }} Form</h1>
                        </div>
                        ...
                        <form class="user" method="post" action="/auth/register">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    <input type="password"
                                      ...
                                      placeholder="Konfirmasi Password" data-toggle="password">
                            ...
                            <div class="form-group">
                                <input type="text" class="form-control @error('address') is-invalid @enderror"
                                  id="address" name="address" placeholder="Alamat lengkap" value="{{ @old(" address") }}">
                                @error('address')
                                <div class="text-danger">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="text-center">
                            <a class="small" href="/auth/login">Sudah punya akun? Login sekarang!</a>
                        </div>
                    </div>
                </div>
            </div>
