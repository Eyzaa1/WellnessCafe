                ...
                <tbody>
                  <tr>
                    <td>
                      <div class="d-flex flex-column">
                        <span class="heading d-block">Pesanan</span>
                    ...
                    <td>
                      <div class="d-flex flex-column">
                        <span class="heading d-block">Tanggal Order</span>
                  ...
                  <tr>
                    <td id="modal_section_payment_proof">
                      <div class="d-flex flex-column">
                        <span class="heading d-block">Bukti Bayar</span>
              ...
              <div class="Produk">
                ...
                <div class="d-flex justify-content-center align-items-center">
                  <a id="link_reject_order" data-bs-dismiss="modal" data-bs-toggle="modal" href="#ModalRejectOrder"
                    title="reject order"><button class="btn btn-outline-danger">Tolak</button></a>
                  <form method="post" id="form_end_order" class="mx-2"> {{-- define form action using jquery --}}
                    @csrf
                    <button class="btn btn-outline-info" id="button_end_order">Selesai</button>
                  </form>
                  <form method="post" id="form_approve_order"> {{-- define form action using jquery --}}
                    @csrf
                    <button class="btn btn-outline-success" id="button_approve_order">Terima</button>
                  </form>
                </div>
                @endif
