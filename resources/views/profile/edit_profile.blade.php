        ...
        <div class="col-xl-4">
            ...
            <div class="card mb-4 mb-xl-0">
                ...
                <div class="card-body text-center">
                    ...
                    <div class="small font-italic text-muted mb-4">Gambar tidak lebih dari 2 MB</div>
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input class="form-control" id="email" name="email" type="text"
                          placeholder="Alamat email" value="{{ auth()->user()->email }}" readonly>
                    </div>
                    <div class="mb-3">
                        <label class="small mb-1" for="username">Username <em class="link-danger">akan ditampilkan pada website</em></label>
                    ...
                    <div class="row gx-3 mb-3">
                        <div class="col-md-6">
                            ...
                            <input class="form-control @error('phone') is-invalid @enderror" id="phone" name="phone"
                              type="text" placeholder="no telepon" value="{{ auth()->user()->phone }}">
                            @error('phone')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="form-group row mb-4">
                        <label for="name" class="col-sm-12 col-form-label">Alamat Lengkap</label>
                        <div class="col-sm-12">
                            <input type="text" class="form-control @error('address') is-invalid @enderror" id="address"
                              name="address" placeholder="Masukkan alamat kamu"
