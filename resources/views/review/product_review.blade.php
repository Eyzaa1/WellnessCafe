      ...
      <div class="tab-content" id="pills-tabContent">
        ...
        <div class="bg-white rounded shadow-sm p-4 mb-4 restaurant-detailed-ratings-and-reviews">
          <div class="d-flex justify-content-between">
            <h5 class="mb-1">Semua Ratings and Reviews</h5>
            <a href="#" class="btn btn-outline-secondary btn-sm float-end">{{ $product->product_name }}</a>
          </div>
          <div class="reviews-members pt-4 pb-4">
            ...
            <div class="media d-flex">
              ...
              <div class="media-body w-100">
                ...
                <div class="w-100 d-flex justify-content-end">
                  <small class="text-muted">Review diedit pada {{ $review->updated_at }}</small>
                </div>
                <?php endif; ?>
              </div>
            </div>
            <?php endforeach; ?>
            @else
            <p class="link-grey">Belum apa review {{ $product->product_name }}.</p>
            @endif
          </div>
        </div>
        ...
        <form action="/review/add_review" method="post">
          ...
          <div class="bg-white rounded shadow-sm p-4 mb-5 rating-review-select-page">
            <h5 class="mb-4">Review produk</h5>
            ...
            <div class="form-group mt-3">
              <button class="btn btn-dark btn-sm" type="submit"> Kirim </button>
            </div>
          </div>
        </form>
        @endif
